...
export default function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "「1LP／CTA1つ／フォーム1つ／自動化Level1（記録＋通知＋自動返信）まで」です。予約確定・決済・LINE連携などはオプションです。",
    },
    {
      question: "GASは自分で触る必要がありますか？",
      answer:
        "初期設定（設置・通知/自動返信・動作確認）はすべてこちらで行います。納品後の変更は運用マニュアルをお渡しします（希望者はオプションでサポート可）。",
    },
    {
      question: "サーバー・ドメインは必要ですか？",
      answer:
        "独自ドメインで公開する場合は必要です。準備ガイドで迷わないように案内します。",
    },
    {
      question: "納期はどれくらいですか？",
      answer:
        "ヒアリング回答が揃ってから最短7日〜が目安です（内容により前後します）。",
    },
  ];
